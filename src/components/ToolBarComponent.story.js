...
storiesOf('ToolBarComponent', module)
  .add('All messages selected path', () =>
    <ToolBarComponent messages={messages} selectedMsgCount={8} />
  )
  .add('Some messages selected path', () =>
    <ToolBarComponent messages={messages} selectedMsgCount={3} />
  )
  .add('No messages selected path', () =>
    <ToolBarComponent messages={messages} selectedMsgCount={0} />
  );
